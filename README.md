...
| :--- | :--- |
| **Programming** | Python (Expert), R, SQL, Java |
| **AI & Machine Learning** | Scikit-learn, TensorFlow, Keras, Regression, Clustering |
| **Big Data & Cloud** | Hadoop, MapReduce, Cloudera, AWS (Certified) |
| **Data Viz & BI** | Power BI, Matplotlib, Pandas, NumPy |
...
* **Key Result:** Achieved a **79% F1-Score**.
